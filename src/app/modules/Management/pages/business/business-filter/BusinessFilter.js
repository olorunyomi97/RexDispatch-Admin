...
export function BusinessFilter({ listLoading }) {
  // Business UI Context
  ...
  const applyFilter = (values) => {
    const newQueryParams = prepareFilter(businessUIProps.queryParams, values);
    if (!isEqual(newQueryParams, businessUIProps.queryParams)) {
      newQueryParams.pageNumber = 1;
      // update list by queryParams
      businessUIProps.setQueryParams(newQueryParams);
    }
  };
