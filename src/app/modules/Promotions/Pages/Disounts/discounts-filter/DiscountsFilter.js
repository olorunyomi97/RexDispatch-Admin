...
export function DiscountsFilter({ listLoading }) {
  ...
  const applyFilter = (values) => {
    const newQueryParams = prepareFilter(discountsUIProps.queryParams, values);
    if (!isEqual(newQueryParams, discountsUIProps.queryParams)) {
      newQueryParams.pageNumber = 1;
      // update list by queryParams
      discountsUIProps.setQueryParams(newQueryParams);
    }
  };
